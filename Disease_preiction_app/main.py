...
def predictDisease(symptoms):
        ...
        DATA_PATH = r"Disease_preiction_app\disease\Training.csv"
    ...
    # Use the function to predict the prognosis
        ...
        final_rf_model = pickle.load(open(r"Disease_preiction_app\models\final_rf_model.pkl", "rb"))
        final_nb_model = pickle.load(open(r"Disease_preiction_app\models\final_nb_model.pkl", "rb"))
        final_svm_model = pickle.load(open(r"Disease_preiction_app\models\final_svm_model.pkl", "rb"))
        final_rnn_model=pickle.load(open(r"Disease_preiction_app\models\RNN_model.pkl", "rb"))
